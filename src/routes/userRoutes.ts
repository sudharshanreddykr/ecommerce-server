...
router.post(
  ...
  [
    ...
    body('phoneNumber').optional().trim().isLength({ min: 7, max: 20 }),
    body('addressLine1').optional().trim().isLength({ min: 3, max: 255 }),
    body('addressLine2').optional().trim().isLength({ max: 255 }),
    body('city').optional().trim().isLength({ min: 2, max: 120 }),
    body('state').optional().trim().isLength({ min: 2, max: 120 }),
    body('postalCode').optional().trim().isLength({ min: 3, max: 20 }),
    body('country').optional().trim().isLength({ min: 2, max: 120 }),
  ],
